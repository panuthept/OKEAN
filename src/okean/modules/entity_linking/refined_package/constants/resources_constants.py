...
DATA_FILES_WIKIDATA = {
    ...
    "roberta_large_model": {
        "s3_bucket": s3_resource_bucket,
        "s3_key": s3_resource_prefix + "wikidata_data/roberta-large/pytorch_model.bin",
        "local_filename": "roberta-large/pytorch_model.bin",
        "needed_for_inference": True
    },
    "roberta_large_model_config": {
        "s3_bucket": s3_resource_bucket,
        "s3_key": s3_resource_prefix + "wikidata_data/roberta-large/config.json",
        "local_filename": "roberta-large/config.json",
        "needed_for_inference": True
    },
    "roberta_large_vocab": {
        "s3_bucket": s3_resource_bucket,
        "s3_key": s3_resource_prefix + "wikidata_data/roberta-large/vocab.json",
        "local_filename": "roberta-large/vocab.json",
        "needed_for_inference": True
    },
    "roberta_large_tokenizer_merges": {
        "s3_bucket": s3_resource_bucket,
        "s3_key": s3_resource_prefix + "wikidata_data/roberta-large/merges.txt",
        "local_filename": "roberta-large/merges.txt",
        "needed_for_inference": True
    },
    "wiki_pem": {
        "s3_bucket": s3_resource_bucket,
...
TEST_DATASET_FILES = {
    "aida": {
        "easy": "aida_easy.jsonl",
        "hard": "aida_hard.jsonl",
        "all": "aida.jsonl",
    },
    "msnbc": {
        "easy": "msnbc_easy.jsonl",
        "hard": "msnbc_hard.jsonl",
        "all": "msnbc.jsonl",
    },
    "aquaint": {
        "easy": "aquaint_easy.jsonl",
        "hard": "aquaint_hard.jsonl",
        "all": "aquaint.jsonl",
    },
    "ace2004": {
        "easy": "ace2004_easy.jsonl",
        "hard": "ace2004_hard.jsonl",
        "all": "ace2004.jsonl",
    },
    "cweb": {
        "easy": "cweb_easy.jsonl",
        "hard": "cweb_hard.jsonl",
        "all": "cweb.jsonl",
    },
    "wiki": {
        "easy": "wiki_easy.jsonl",
        "hard": "wiki_hard.jsonl",
        "all": "wiki.jsonl",
    },
    "shadow": {
        "easy": "shadow_easy.jsonl",
        "hard": "shadow_hard.jsonl",
        "all": "shadow.jsonl",
    },
    "top": {
        "easy": "top_easy.jsonl",
    ...
    "tail": {
        "easy": "tail_easy.jsonl",
        "hard": "tail_hard.jsonl",
        "all": "tail.jsonl",
    },
    "webqsp": {
        "easy": "webqsp_easy.jsonl",
        "hard": "webqsp_hard.jsonl",
        "all": "webqsp.jsonl",
    },
    "graphq": {
        "easy": "graphq_easy.jsonl",
        "hard": "graphq_hard.jsonl",
        "all": "graphq.jsonl",
    },
    "mintaka": {
        "easy": "mintaka_easy.jsonl",
        "hard": "mintaka_hard.jsonl",
        "all": "mintaka.jsonl",
    },
    "tweeki": {
        "easy": "tweeki_easy.jsonl",
        "hard": "tweeki_hard.jsonl",
        "all": "tweeki.jsonl",
    },
    "reddit_comments": {
        "easy": "reddit_comments_easy.jsonl",
        "hard": "reddit_comments_hard.jsonl",
        "all": "reddit_comments.jsonl",
    },
    "reddit_posts": {
        "easy": "reddit_posts_easy.jsonl",
        "hard": "reddit_posts_hard.jsonl",
        "all": "reddit_posts.jsonl",
    },
}
...
DATASET_DATA_FILES = {
    ...
    "shadowlink_shadow": {
        "url": "https://huggingface.co/datasets/vera-pro/ShadowLink/raw/main/Shadow.json",
        "download_filename": "Shadow.json",
        "local_filename": "shadowlink_shadow.json",
    },
    "shadowlink_tail": {
        "url": "https://huggingface.co/datasets/vera-pro/ShadowLink/raw/main/Tail.json",
        "download_filename": "Tail.json",
        "local_filename": "shadowlink_tail.json",
    },
    "shadowlink_top": {
        "url": "https://huggingface.co/datasets/vera-pro/ShadowLink/raw/main/Top.json",
        "download_filename": "Top.json",
        "local_filename": "shadowlink_top.json",
    },
    ...
    "graphq_train_data_el": {
        "url": "http://dl.fbaipublicfiles.com/elq/EL4QA_data.tar.gz",
        "download_filename": "EL4QA_data.tar.gz",
        "extract_mapping": {
            "train": ["EL4QA_data/graphquestions_EL/train.jsonl", "graphq_train_data_el.json"],
            "dev": ["EL4QA_data/graphquestions_EL/dev.jsonl", "graphq_dev_data_el.json"],
            "test": ["EL4QA_data/graphquestions_EL/test.jsonl", "graphq_test_data_el.json"],
        },
        "local_filename": "graphq_train_data_el.json",
    },
    "graphq_dev_data_el": {
        "url": "http://dl.fbaipublicfiles.com/elq/EL4QA_data.tar.gz",
        "download_filename": "EL4QA_data.tar.gz",
        "extract_mapping": {
            "train": ["graphquestions_EL/train.jsonl", "graphq_train_data_el.json"],
            "dev": ["graphquestions_EL/dev.jsonl", "graphq_dev_data_el.json"],
            "test": ["graphquestions_EL/test.jsonl", "graphq_test_data_el.json"],
        },
        "local_filename": "graphq_dev_data_el.json",
    },
    "graphq_test_data_el": {
        "url": "http://dl.fbaipublicfiles.com/elq/EL4QA_data.tar.gz",
        "download_filename": "EL4QA_data.tar.gz",
        ...
        "local_filename": "graphq_test_data_el.json",
    },

    # Mintaka EL
    "mintaka_train_data_el": {
        "url": "https://raw.githubusercontent.com/amazon-science/mintaka/main/data/mintaka_train.json",
        "download_filename": "mintaka_train.json",
        "local_filename": "mintaka_train_data_el.json",
    },
    "mintaka_dev_data_el": {
        "url": "https://raw.githubusercontent.com/amazon-science/mintaka/main/data/mintaka_dev.json",
        "download_filename": "mintaka_dev.json",
        "local_filename": "mintaka_dev_data_el.json",
    },
    "mintaka_test_data_el": {
        "url": "https://raw.githubusercontent.com/amazon-science/mintaka/main/data/mintaka_test.json",
        "download_filename": "mintaka_test.json",
        "local_filename": "mintaka_test_data_el.json",
    }
}
