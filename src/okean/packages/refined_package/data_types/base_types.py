...
class Span:
    ...
    all_predicted_entities: Optional[List[Tuple[Entity, float]]] = None
    predicted_entity_types: Optional[List[Tuple[str, str, float]]] = None  # (type_id, type_label, confidence)
    sorted_predicted_entity_types: Optional[List[str]] = None
    ...
    predicted_entity_2: Optional[Entity] = None
    entity_linking_model_confidence_score_2: Optional[float] = None
    top_k_predicted_entities_2: Optional[Tuple[List[Entity], float]] = None
