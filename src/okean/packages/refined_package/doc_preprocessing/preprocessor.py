...
from okean.packages.refined_package.doc_preprocessing.candidate_generator import CandidateGenerator, CandidateGeneratorExactMatch
from okean.packages.refined_package.doc_preprocessing.class_handler import ClassHandler
from okean.packages.refined_package.resource_management.data_lookups import LookupsInferenceOnly
from okean.packages.refined_package.data_types.base_types import Token, Span
...
class PreprocessorInferenceOnly(Preprocessor):
    ...
    def get_transformer_model(self):
        return self.lookups.get_transformer_model(self.transformer_name)
