...
from okean.packages.refined_package.utilities.md_dataset_utils import bio_to_offset_pairs
from okean.packages.refined_package.data_types.modelling_types import BatchElement, BatchedElementsTns, ModelReturn
from okean.packages.refined_package.data_types.base_types import Span
from okean.packages.refined_package.doc_preprocessing.preprocessor import Preprocessor
from okean.packages.refined_package.utilities.preprocessing_utils import pad
from okean.packages.refined_package.model_components.config import ModelConfig
from okean.packages.refined_package.model_components.ed_layer_2 import EDLayer
from okean.packages.refined_package.model_components.entity_disambiguation_layer import EntityDisambiguation
from okean.packages.refined_package.model_components.entity_typing_layer import EntityTyping
from okean.packages.refined_package.model_components.mention_detection_layer import MentionDetection
from okean.packages.refined_package.utilities.model_utils import fill_tensor
from okean.packages.refined_package.utilities.general_utils import get_logger
...
class RefinedModel(nn.Module):
    ...
    def forward(
        ...
        encoding_time = time.time() - encoding_init_time
        ...
        ed_time = time.time() - ed_init_time
