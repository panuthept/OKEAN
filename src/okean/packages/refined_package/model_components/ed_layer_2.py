...
from okean.packages.refined_package.model_components.description_encoder import DescriptionEncoder
...
class EDLayer(nn.Module):
    def __init__(
        ...
        self.description_encoder = DescriptionEncoder(
            output_dim=output_dim, mention_dim=mention_dim, ff_chunk_size=4, preprocessor=preprocessor
        )
